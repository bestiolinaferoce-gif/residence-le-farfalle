...
const Location: React.FC<LocationProps> = ({ locale = "it" }) => {
  const { t, raw } = useLocaleStrings("locationSection");
  const attractions = raw<Attraction[]>("attractions");
                ...
                <Card hover className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mb-2 text-sm text-neutral-600">{attraction.description}</p>
