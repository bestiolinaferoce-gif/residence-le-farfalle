...
const COPY: Record<Loc, Copy> = {
  it: {
    ...
    title: "Bandiera Blu 2026 a Isola di Capo Rizzuto: dormire vicino alle spiagge premiate",
    intro:
      "Il 14 maggio 2026 la Foundation for Environmental Education ha confermato Isola di Capo Rizzuto tra i Comuni Bandiera Blu 2026. La Calabria sale al 2° posto in Italia con 27 spiagge premiate, a pari merito con la Puglia, dietro la sola Liguria. Il Residence Le Farfalle si trova nel cuore di Isola di Capo Rizzuto, a circa 6 km (10–15 minuti in auto) dalle spiagge dell'Area Marina Protetta, all'interno del Comune premiato.",
    whyHere: {
      title: "Perché soggiornare qui in zona Bandiera Blu",
      text: "Soggiornare al Residence Le Farfalle significa trovarsi a circa 10–15 minuti in auto da spiagge che hanno appena ottenuto il riconoscimento Bandiera Blu 2026. 4 camere indipendenti con bagno privato, colazione inclusa, WiFi superfast e aria condizionata. Parcheggio gratuito a 50 metri. Il riconoscimento Bandiera Blu è un dato pubblico verificabile e attestato annualmente: certifica qualità delle acque di balneazione, gestione ambientale, raccolta differenziata, servizi turistici e sicurezza in spiaggia.",
    },
    beachesTitle: "Spiagge raggiungibili",
    beaches: [
      { name: "Area Marina Protetta Capo Rizzuto", distance: "10–15 min in auto · circa 6 km", note: "Riserva marina con acque cristalline, snorkeling e immersioni nel Comune premiato." },
      { name: "Spiagge di Le Castella", distance: "15 min in auto · circa 11 km", note: "Sabbia dorata e mare turchese con la Fortezza Aragonese. Stesso Comune premiato." },
      { name: "Capo Colonna", distance: "25 min in auto · 15 km", note: "Sito archeologico magno-greco a picco sul mare." },
      { name: "Spiagge Rosse", distance: "10–15 min in auto · circa 6 km", note: "Sabbia rosso cannella e fondali trasparenti nell'Area Marina Protetta." },
      { name: "Crotone — costa ionica", distance: "20–25 min in auto · circa 18 km", note: "Spiagge urbane e lungomare con museo archeologico." },
    ],
    list: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "No: la Bandiera Blu viene assegnata ai Comuni e alle spiagge, non alle singole strutture ricettive. Residence Le Farfalle si trova all'interno del Comune di Isola di Capo Rizzuto, premiato Bandiera Blu 2026, a circa 6 km (10–15 minuti in auto) dalle spiagge dell'Area Marina Protetta.",
      },
      {
      ...
      {
        q: "Come verifico la disponibilità?",
        a: "Abbiamo 4 camere, quindi luglio e agosto si riempiono prima degli altri mesi. Inviaci date e numero di ospiti: ti rispondiamo con disponibilità e prezzo esatto, senza impegno.",
      },
    ],
  ...
  en: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "No: the Blue Flag is awarded to municipalities and beaches, not to individual accommodation providers. Residence Le Farfalle is located within the municipality of Isola di Capo Rizzuto, Blue Flag 2026, about 6 km (10–15 minutes by car) from the Marine Protected Area beaches.",
      },
      {
      ...
      },
      {
        ...
        a: "We have 4 rooms, so July and August tend to fill up earlier than other months. Send us your dates and number of guests: we'll reply with availability and the exact price, no obligation.",
      },
    ],
  ...
  de: {
    ...
    title: "Blaue Flagge 2026 in Isola di Capo Rizzuto: in der Nähe der prämierten Strände übernachten",
    intro:
      "Am 14. Mai 2026 hat die Foundation for Environmental Education Isola di Capo Rizzuto erneut mit der Blauen Flagge 2026 ausgezeichnet. Kalabrien steigt mit 27 ausgezeichneten Stränden auf Platz 2 in Italien auf, gleichauf mit Apulien und hinter Ligurien. Das Residence Le Farfalle befindet sich im Herzen von Isola di Capo Rizzuto, rund 6 km (10–15 Autominuten) von den Stränden des Meeresschutzgebiets entfernt, innerhalb der ausgezeichneten Gemeinde.",
    whyHere: {
      title: "Warum in einer Blaue-Flagge-Region übernachten",
      text: "Im Residence Le Farfalle wohnen Sie nur rund 10–15 Autominuten von Stränden entfernt, die gerade mit der Blauen Flagge 2026 ausgezeichnet wurden. 4 separate Zimmer mit Privatbad, Frühstück inklusive, superschnelles WLAN und Klimaanlage. Kostenloser Parkplatz 50 Meter entfernt. Die Blaue Flagge ist eine öffentlich überprüfbare jährliche Auszeichnung: Sie zertifiziert Badegewässerqualität, Umweltmanagement, Mülltrennung, touristische Dienstleistungen und Strandsicherheit.",
    },
    beachesTitle: "Erreichbare Strände",
    beaches: [
      { name: "Meeresschutzgebiet Capo Rizzuto", distance: "10–15 Min. mit dem Auto · ca. 6 km", note: "Meeresreservat mit kristallklarem Wasser, Schnorcheln und Tauchen in der prämierten Gemeinde." },
      { name: "Strände von Le Castella", distance: "15 Min. mit dem Auto · ca. 11 km", note: "Goldener Sand und türkisfarbenes Meer mit aragonesischer Festung. Gleiche prämierte Gemeinde." },
      { name: "Capo Colonna", distance: "25 Min. mit dem Auto · 15 km", note: "Magno-griechische archäologische Stätte über dem Meer." },
      { name: "Spiagge Rosse", distance: "10–15 Min. mit dem Auto · ca. 6 km", note: "Zimtroter Sand und klares Wasser im Meeresschutzgebiet." },
      { name: "Crotone — ionische Küste", distance: "20–25 Min. mit dem Auto · ca. 18 km", note: "Stadtstrände und Strandpromenade mit archäologischem Museum." },
    ],
    list: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Nein: Die Blaue Flagge wird Gemeinden und Stränden verliehen, nicht einzelnen Beherbergungsbetrieben. Das Residence Le Farfalle befindet sich in der Gemeinde Isola di Capo Rizzuto, Blaue Flagge 2026, rund 6 km (10–15 Autominuten) von den Stränden des Meeresschutzgebiets entfernt.",
      },
      {
      ...
      {
        q: "Wie prüfe ich die Verfügbarkeit?",
        a: "Wir haben 4 Zimmer, daher sind Juli und August meist früher belegt als andere Monate. Nennen Sie uns Reisedaten und Gästezahl: Wir antworten mit Verfügbarkeit und genauem Preis, unverbindlich.",
      },
    ],
    ctaTitle: "Übernachten Sie in einer Blaue-Flagge-Region 2026",
        ...
        <section className="mt-16 rounded-3xl bg-gradient-to-br from-secondary-700 to-secondary-900 px-6 py-12 text-center sm:px-12">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <Link href={`/${currentLocale}/prenota`}>
              <Button asSpan variant="primary" size="lg">{c.ctaPrimary}</Button>
            </Link>
            <Link href={`/${currentLocale}/camere`}>
              <Button asSpan variant="secondary" size="lg" className="border border-white/30 bg-transparent text-white hover:bg-white/10">
                {c.ctaSecondary}
              </Button>
            </Link>
          </div>
