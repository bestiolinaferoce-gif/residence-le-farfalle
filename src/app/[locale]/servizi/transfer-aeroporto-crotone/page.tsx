...
const copy: Record<Locale, Copy> = {
  it: {
    ...
    intro:
      "Arriva a Isola di Capo Rizzuto senza pensieri: organizziamo il transfer privato da e per l'aeroporto di Crotone (Sant'Anna), a circa 25 minuti dalla struttura. Un servizio comodo soprattutto per chi viaggia senza auto.",
    priceLabel: "Prezzo",
    ...
    points: [
      ...
      { icon: "clock", text: "Circa 25 minuti di tragitto fino alla struttura." },
  ...
  en: {
    ...
    intro:
      "Arrive in Isola di Capo Rizzuto stress-free: we arrange a private transfer to and from Crotone (Sant'Anna) airport, about 25 minutes from the property. A convenient service, especially if you travel without a car.",
    priceLabel: "Price",
    ...
    points: [
      ...
      { icon: "clock", text: "About a 25-minute drive to the property." },
  ...
  de: {
    ...
    intro:
      "Kommen Sie entspannt in Isola di Capo Rizzuto an: Wir organisieren einen privaten Transfer vom und zum Flughafen Crotone (Sant'Anna), ca. 25 Minuten von der Unterkunft. Besonders praktisch, wenn Sie ohne Auto reisen.",
    priceLabel: "Preis",
    ...
    points: [
      ...
      { icon: "clock", text: "Etwa 25 Minuten Fahrt bis zur Unterkunft." },
