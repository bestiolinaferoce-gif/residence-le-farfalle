...
export interface Room {
  ...
  images: string[];
  priceFrom: number;
  /** Etichette brevi: solo in italiano nei dati storici, non mostrate nelle pagine tradotte. */
  highlights: string[];
}
...
export const rooms: Room[] = [
  {
    ...
    description: {
      it: "Camera Limone, 20 mq di comfort nel cuore di Isola di Capo Rizzuto. Ideale per coppie che cercano un soggiorno autentico in Calabria, offre luce naturale abbondante, bagno privato con doccia, TV LED, aria condizionata e WiFi superfast inclusi. La colazione viene servita ogni mattina. A pochi minuti a piedi dal centro paese e a circa 6 km (10–15 minuti in auto) dalle spiagge dell’Area Marina Protetta di Capo Rizzuto. La gestione della struttura è disponibile per consigli su spiagge e itinerari sulla costa ionica.",
      en: "Limone Room, 20 sqm of comfort in the heart of Isola di Capo Rizzuto. Perfect for couples seeking an authentic Calabrian stay, it features abundant natural light, a private bathroom with shower, LED TV, air conditioning and superfast WiFi. Breakfast is served every morning. A short walk from the town centre and about 6 km (10–15 minutes by car) from the beaches of the Capo Rizzuto Marine Protected Area. Our team is happy to share tips and quieter spots along the Ionian coast.",
      de: "Zimmer Limone, 20 m² Komfort im Herzen von Isola di Capo Rizzuto. Ideal für Paare, die einen authentischen Aufenthalt in Kalabrien suchen: viel Tageslicht, eigenes Bad mit Dusche, LED-TV, Klimaanlage und superschnelles WLAN inklusive. Das Frühstück wird jeden Morgen serviert. Nur wenige Gehminuten vom Ortskern und ca. 6 km (10–15 Autominuten) von den Stränden des Meeresschutzgebiets Capo Rizzuto entfernt. Das Team der Residence steht mit Tipps für die ionische Küste jederzeit zur Verfügung.",
    },
    capacity: 2,
    beds: 1,
    size: 20,
  ...
  },
  {
    ...
    amenities: ["private-bathroom", "tv", "ac", "wifi", "blackout"],
    images: [
      "le-farfalle-matrimoniale-04.png",
